...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (carToFollow != null)
        {
            ...
            offset.x = carToFollow.transform.forward.x * Mathf.Clamp(offset.x, 4.0f, 10.0f);
            offset.y = Mathf.Clamp(offset.y, -5.0f, -1.0f);
            offset.z = carToFollow.transform.forward.z * Mathf.Clamp(offset.z, 4.0f, 10.0f);
